...
@section('main-container')
    <div class="content-body">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ route('works.update', ['id' => $works->workid]) }}" method="POST"
                ...
                <div class="form-group mb-3">
                    ...
                    @if ($works->image)
                        <div class="mt-2">
                            <img src="{{ url($works->image) }}" alt="Project Image" width="200">
                        </div>
                    @endif
                </div>
                <div class="form-floating mb-3">
                    <textarea class="form-control" id="details" rows="5" placeholder="Project Details" name="details">{{ $works->details }}</textarea>
